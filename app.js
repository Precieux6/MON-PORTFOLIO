...
// Web3Forms gère nativement l'envoi via le formulaire HTML
// Aucune logique JavaScript supplémentaire n'est nécessaire
function initContactForm() {
  // Le formulaire est configuré pour envoyer directement via Web3Forms
  // Pas d'intervention JavaScript requise
}
